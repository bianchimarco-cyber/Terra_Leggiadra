...
CREATE TABLE IF NOT EXISTS vendite (
    ...
    unita_misura ENUM('kg', 'quarta', 'litri') NOT NULL DEFAULT 'kg',
...
INSERT INTO vendite (data_vendita, tipo, quantita, unita_misura, kg_effettivi, prezzo_unitario, ricavo_totale, acquirente) VALUES
    (DATE_SUB(CURDATE(), INTERVAL 5 DAY), 'Olio', 150.00, 'litri', 150.00, 12.50, 1875.00, 'Privati Locali'),
    (DATE_SUB(CURDATE(), INTERVAL 2 DAY), 'Olio', 80.00, 'litri', 80.00, 13.00, 1040.00, 'Ristorante Da Mario'),
    (DATE_SUB(CURDATE(), INTERVAL 8 DAY), 'Olive', 4.00, 'quarta', 50.00, 11.00, 44.00, 'Mercato Locale');
