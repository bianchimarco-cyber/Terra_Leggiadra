...
<header class="topbar">
  ...
  <div class="topbar-right">
    <span class="stagione-badge">Stagione 2026</span>
  </div>
</header>
          ...
          <table>
            <thead>
              <tr>
                ...
                <th class="text-right">Prezzo/Unità</th><th class="text-right">Ricavo</th><th>Acquirente</th>
              </tr>
            </thead>
      ...
      <div class="card">
        ...
        <form onsubmit="saveVendita(event)">
          ...
          <div class="form-group">
            ...
            <select id="vend_tipo" name="tipo" class="form-select" required onchange="onTipoVenditaChange()">
          ...
          <div class="form-group">
            ...
            <select id="vend_unita" name="unita_misura" class="form-select" onchange="updateRicavo()">
              <option value="litri">Litri (L)</option>
            </select>
            <div class="form-hint" id="vend_unita_hint">Per le olive puoi scegliere tra kg e quarte (1 quarta = 12,5 kg)</div>
          </div>
          <div class="form-row">
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="form-label" id="vend_prezzo_label">Prezzo (€/litro)</label>
              <input type="number" id="vend_prezzo" name="prezzo_unitario" class="form-input" step="0.01" min="0.01" placeholder="12.00" required oninput="updateRicavo()">
            </div>
          </div>
          <div class="form-hint" id="vend_ricavo_preview" style="color:var(--olive);font-weight:500;margin-bottom:10px;min-height:18px;"></div>
          <div class="form-group">
            <label class="form-label">Acquirente</label>
            <input type="text" name="acquirente" class="form-input" placeholder="Es. Privato, Ristorante Da Mario...">
          </div>
